        ...
        return (
          ...
          >
            ...
            <Link
              ...
              className="relative block hover:bg-white/[0.02] transition-colors"
            >
              <div className="container mx-auto px-4 md:px-6 lg:px-10 grid grid-cols-12 gap-6 md:gap-8 items-center py-8 md:py-10">
                ...
                <div className="col-span-12 md:col-span-5 space-y-3 md:space-y-4">
                  <div>
                ...
                <div className="col-span-12 md:col-span-3 hidden md:block relative aspect-[4/3] overflow-hidden border border-white/10">
                  <Image
                    src={unit.image_url}
                    alt={unit.name}
                    fill
                ...
                <div className="col-span-12 md:col-span-2 flex md:flex-col md:items-end gap-3 md:gap-5">
                  ...
                  <ul className="hidden md:flex flex-col gap-1.5 items-end">
                    {visibleServices.map((service) => (
                      <li
                        key={service}
                        className="font-mono text-[10px] uppercase tracking-[0.18em] text-white/50 text-right"
                      >
                        / {service}
                      </li>
                    ))}
