...
export default function HeroLogo({ text, className = "" }: HeroLogoProps) {
  ...
  // Improved parallax effects - more subtle and smooth
  ...
  if (!mounted) {
    return (
      <div className={`min-h-[40vh] sm:min-h-[50vh] md:min-h-[60vh] lg:min-h-[70vh] flex items-center justify-center py-8 md:py-12 ${className}`}>
        <h1 className="text-display font-black text-center px-4 md:px-6 text-stroke">
          {text}
        </h1>
      </div>
    )
  ...
  return (
    ...
    >
      <motion.h1
        ...
        className="text-display font-black text-center px-4 md:px-6 text-stroke will-change-transform"
      >
        {text}
      </motion.h1>
    </motion.div>
