...
export const mockArtists: Artist[] = [
  ...
  },
  {
    ...
    slug: "abner-dk",
    name: "Abner DK",
    bio: "Rapero y cantautor bogotano que lleva la sensibilidad del piano clásico al rap: canciones íntimas y poéticas entre lo urbano, lo latino y lo experimental.",
    bio_full: "Abner DK llegó al rap por el camino menos esperado: el piano clásico.\n\nNacido en Bogotá, empezó a tocar a los cinco años y creció entre partituras de Chopin y Beethoven, encontrando en el piano el lenguaje para decir lo que no cabía en palabras. De ahí saltó a los teclados de una banda de ska y reggae, donde descubrió el escenario, y finalmente a la música que hoy lo define: un rap íntimo y poético, de versos suaves casi hablados, sobre beats que cruzan lo urbano, lo latino y lo experimental. Un sonido difícil de encasillar que él resume en dos palabras: neo urbano.\n\nSu álbum debut, \"Agua\" (2025), nació del duelo por la muerte de su madre. Es un ciclo vital contado en canciones que fluyen como la lluvia, crecen como el diluvio y terminan con la luz del sol: un disco sobre el amor, la pérdida y la fuerza de empezar de nuevo. Tras \"Agua\" vino una colaboración de reggaetón junto al productor del álbum, prueba de que su rango va del verso confesional al ritmo de fiesta.\n\nAhora prepara \"One Life Is All You Get\", el disco que considera su verdadero debut, titulado con la frase que firma sus canciones y que resume su filosofía: la vida es una sola y hay que arriesgarse a vivirla con autenticidad.\n\nEn vivo, Abner DK concibe cada show como una obra de teatro íntima: la energía de una banda, el dramatismo de una puesta en escena y la música unida al baile y al performance.\n\nPara oyentes de Mac Miller, Canserbero y el rap alternativo latinoamericano, Abner DK es una de las voces nuevas de la escena bogotana que vale la pena escuchar desde ya.",
    tagline: "Neo urbano desde Bogotá. One life is all you get.",
    genre: "Neo urbano",
    meta_description: "Abner DK: rapero y cantautor bogotano de sonido neo urbano. Escucha su álbum Agua, mira sus fotos y contáctalo para booking y prensa.",
    booking_email: "abnerdk@mgcompany.co",
    location: "Bogotá, Colombia",
    agent_id: "1",
    photo_url: "/artists/abner-dk/abner-card.jpg",
    hero_image_url: "/artists/abner-dk/abner-hero.jpg",
    gallery: [
      "/artists/abner-dk/abner-gal-01.jpg",
      "/artists/abner-dk/abner-gal-02.jpg",
      "/artists/abner-dk/abner-gal-03.jpg",
      "/artists/abner-dk/abner-gal-04.jpg",
      "/artists/abner-dk/abner-gal-05.jpg",
      "/artists/abner-dk/abner-gal-06.jpg",
    ],
    social_links: {
      instagram: "https://www.instagram.com/this_is_abnerdk/",
      tiktok: "https://www.tiktok.com/@this_is_abnerdk",
      spotify: "https://open.spotify.com/artist/7wXE9ROf93Y39SOKmTphYH",
    },
    media: {
      audio: [],
      video: [],
    ...
    discography: [
      { title: "Agua", year: 2025, spotify_url: "https://open.spotify.com/album/6USG3UdSLTO0Rwq4DiKBB6" },
    ],
  },
  {
    id: "7",
  ...
  },
  {
    ...
    slug: "karen-dayanna",
    name: "Karen Dayanna",
    bio: "Cantautora bogotana que cruza la cancion de autor con el pop, el indie, el folclore y el soft rock. Letras sobre memoria, transformacion y todo lo que perdura.",
    bio_full: "Karen Dayanna es una cantautora de Bogota con una propuesta que combina el alma de la cancion de autor con influencias del pop, el indie, el folclore y el soft rock, logrando un sonido fresco y sensible. A traves de sus letras busca explorar los procesos de transformacion, cargados de emocion y honestidad, invitando a quien escucha a reconocerse en ellas.\n\nSu obra trasciende a la memoria y el recuerdo, habita y crea alrededor de la levedad del ser. Viste y se abandera en la piel de todo lo sensible, lo intimo y lo humano, siendo una extension artistica del inherente deseo de encontrarse a si mismo.\n\nSus presentaciones combinan el abrazo calido de la remembranza, la profundidad sonora y una conexion intensa con las emociones, creando experiencias inmersivas en cada escenario.\n\nA traves de plataformas digitales, performances en vivo y eventos, Karen abre su camino en la escena emergente, posicionandose como una de las voces frescas que apuestan por la autenticidad en la musica independiente de Bogota.",
    tagline: "Mucho mas que un show.",
