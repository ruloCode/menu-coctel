        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-10 pt-16 md:pt-24 pb-10 md:pb-12">
          <ScrollReveal direction="up">
            <SectionHeading
              ...
              subtitle="Cuatro unidades. Un equipo. Producción de punta a punta para artistas, sellos y marcas que quieren resultados, no powerpoints."
            />
          </ScrollReveal>
        </div>
        <ServicesList businessUnits={businessUnits} />
      ...
      <section className="container mx-auto px-4 md:px-6 lg:px-10 py-16 md:py-24">
        <ScrollReveal direction="up">
          <SectionHeading
            ...
            kicker="Roster"
            title="Artistas"
            subtitle="Cinco voces. Cinco proyectos. Una sola productora detrás. Construyen el próximo sonido del Caribe y la diáspora latina."
        ...
        >
          ...
          <div className="relative container mx-auto px-4 md:px-6 lg:px-10 py-16 md:py-24">
            <ScrollReveal direction="up">
              <SectionHeading
                index="05"
                kicker="Contenido propio"
                title="MG Flow"
                subtitle="Sesiones, documentales y series originales. Lo que pasa entre el estudio, la calle y el escenario."
                className="mb-10 md:mb-14"
              />
            </ScrollReveal>
            <ScrollReveal direction="up" delay={0.2}>
